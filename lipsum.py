# Текстовые абзацы для вставки (5 различных абзацев Lorem Ipsum)
paragraphs = [  #
...
Aenean placerat. %
Ut imperdiet, %
enim sed gravida sollicitudin, %
felis odio placerat quam, %
...
Morbi fringilla, %
wisi in dignissim interdum, %
justo lectus sagittis dui, %
